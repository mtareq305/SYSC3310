...
/*
	Modified InputOutput.c this includes  Interrupt-Driven Program
*/	
...
/*Interrupt counter and Interrupt flag initialize here*/
void EdgeCounter_Init(void){
	__ASM("CPSID I");
	
  FallingEdges = 0;                // initialize FallingEdges counter
